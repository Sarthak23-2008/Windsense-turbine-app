...
export const CentrifugalGovernorModel: React.FC<CentrifugalGovernorModelProps> = ({
  ...
  const [rotorRpm, setRotorRpm] = useState<number>(initialRpm);
  ...
  const [liveState, setLiveState] = useState<StandaloneGovernorState>(() =>
    calculateGovernorStep(initialRpm, 0, 0.05, DEFAULT_GOVERNOR_PARAMS)
  );

  // Sync external RPM prop when updated
  useEffect(() => {
  ...
  const xRatio = liveState.governorPositionPct / 100; // 0 to 1
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4 relative overflow-hidden">
        ...
        <div className="space-y-1.5 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-slate-400 max-w-3xl leading-relaxed">
            Converts rotational kinetic speed into physical sleeve displacement via centrifugal force (F_c = m × r × ω²) opposed by a calibrated spring (F_s = F_preload + k × x). Pure mechanical intelligence — zero electronics or software rules.
          </p>
        </div>
      ...
      <div className="bg-slate-900/95 border border-slate-800 rounded-2xl p-5 shadow-2xl space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 space-y-1.5">
            ...
            <div className="text-[10px] text-slate-500 font-mono pt-1 border-t border-slate-900">
              Full-Extension Flyweight Radial Stop
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-slate-950 border border-slate-800 rounded-2xl p-5 shadow-2xl flex flex-col justify-between space-y-4 relative overflow-hidden">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 flex items-center justify-center min-h-[320px]">
            <svg viewBox="0 0 450 320" className="w-full h-auto max-h-[340px]">
              <defs>
              ...
              {/* Central Drive Shaft */}
              <rect x="215" y="20" width="20" height="280" fill="#334155" rx="4" stroke="#475569" strokeWidth="1.5" />
              
              {/* Shaft Centerline */}
              <line x1="225" y1="10" x2="225" y2="310" stroke="#64748b" strokeWidth="1" strokeDasharray="4 4" />

              {/* Top Fixed Shaft Collar */}
              <rect x="185" y="40" width="80" height="24" fill="#1e293b" stroke="#f59e0b" strokeWidth="2" rx="4" />
              ...
              <g transform={`translate(0, ${sleeveOffsetY})`}>
                ...
                <text x="310" y="218" fill="#10b981" fontSize="9" fontWeight="bold" textAnchor="start">
              ...
              {(() => {
                ...
                return (
                  <g>
                    ...
                    <line x1={leftX} y1={leftY} x2={leftX - 35} y2={leftY} stroke="#f59e0b" strokeWidth="2.5" markerEnd="url(#forceFc)" />
                    <text x={leftX - 40} y={leftY - 8} fill="#f59e0b" fontSize="9" fontWeight="bold" textAnchor="end">
              ...
              {(() => {
                ...
                return (
                  <g>
                    ...
                    <line x1={rightX} y1={rightY} x2={rightX + 35} y2={rightY} stroke="#f59e0b" strokeWidth="2.5" markerEnd="url(#forceFc)" />
                    <text x={rightX + 40} y={rightY - 8} fill="#f59e0b" fontSize="9" fontWeight="bold" textAnchor="start">
              ...
              <line x1="170" y1="200" x2="280" y2="200" stroke="#64748b" strokeWidth="1" strokeDasharray="3 3" />
              <text x="140" y="204" fill="#64748b" fontSize="8" fontFamily="monospace" textAnchor="end">
                Resting (0mm)
              </text>

              <line x1="170" y1="260" x2="280" y2="260" stroke="#e11d48" strokeWidth="1" strokeDasharray="3 3" />
              <text x="140" y="264" fill="#e11d48" fontSize="8" fontFamily="monospace" textAnchor="end">
          ...
          <div className="text-[11px] text-slate-400 text-center font-mono">
            Rotor RPM = {rotorRpm.toFixed(0)} • Flyweights move radially ({liveState.radiusMm.toFixed(0)} mm) driving axial stroke x ({liveState.displacementMm.toFixed(1)} mm).
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-3">
            ...
            <div className="bg-slate-950 p-3 rounded-xl border border-slate-800/80 flex justify-between items-center text-xs">
              <span className="text-slate-300 font-semibold">Net Force (F_c - F_s):</span>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-3">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
          ...
          <span className="text-xs font-mono text-amber-400 font-bold bg-slate-950 px-2.5 py-1 rounded border border-slate-800">
            Live: {liveState.governorPositionPct.toFixed(1)}% at {rotorRpm.toFixed(0)} RPM
          </span>
        </div>
